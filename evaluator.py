...
class Evaluator:
    ...
    def evaluate_dataset(self, test_dataset):
        ...
        for source, target in tqdm(test_dataset):
            prediction = self.predictor.prediction_one(source, num_candidates=1)[0]
