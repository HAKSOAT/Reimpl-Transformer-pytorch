...
class Predictor:
    def __init__(self, preprocess, postprocess, model,
                 checkpoint_filepath, max_length=30, beam_size=8):
    ...
    def prediction_one(self, source, num_candidates=5):
        ...
        for _ in range(self.max_length):
            # Q: I wonder why get_current_state is being used as the input when it is the beam size.
        ...
        sources, ks = beam.sort_finished(minimum=num_candidates)
